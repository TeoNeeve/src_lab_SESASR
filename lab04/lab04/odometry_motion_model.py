...
def evaluate_sampling_dist(mu, sigma, n_samples, sample_function):
    ...
    plt.grid()
    plt.savefig("/workspaces/vscode_ros2_workspace/src/lecture_notebooks/Robot_Localization/gaussian_dist.pdf")
    plt.show()
...
def main():
    ...
    plt.savefig("/workspaces/vscode_ros2_workspace/src/lecture_notebooks/Robot_Localization/odometry_samples.pdf")
    plt.show()
    ...
    plt.savefig("/workspaces/vscode_ros2_workspace/src/lecture_notebooks/Robot_Localization/multi_odometry_samples.pdf")
    plt.show()
