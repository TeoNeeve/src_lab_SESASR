...
class RobotEKF:
    ...
    def predict_five(self, u, sigma_u, g_extra_args=()):
        """
    ...
    def update_five(self, z, eval_hx, eval_Ht, Qt, Ht_args=(), hx_args=(),  residual=np.subtract, **kwargs):
        ...
        residual : function (z, z2), optional
            ...
            the two measurement vector. If you do not provide this, then the
