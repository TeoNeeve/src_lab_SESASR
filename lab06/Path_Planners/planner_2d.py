import lab06.Path_Planners.utils
from lab06.Path_Planners.utils import Node


class Planner2D:
    """Base class to implement a 2D planner"""

    def __init__(self, grid_map, movements_class: lab06.Path_Planners.utils.Movements):
